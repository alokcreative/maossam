...
const ProfileTour = () => {
	...
	const formik = useFormik({
		...
		onSubmit: (values) => {
			// console.log(values);
			if (values.tourLink === 'workingTimeSlot') {
				navigate('/timeslot');
				setIsOpen(false);
			}
		...
		<div className='row'>
			<div className=' d-flex align-items-center'>
				<div>
						...
						{userData.role=== Role.admin ? (
							...
							<ChecksGroup>
								<Checks
									...
									type='radio'
									name='tourLink'
									value='workingTimeSlot'
									onChange={formik.handleChange}
									checked={formik.values.tourLink}
									label='Working time slot'
								/>
					...
					<div className='my-3'>
						You can also skip this step for now and update it later
					</div>
					<div className='col-12 mt-3'>
						<div className='row'>
							<div className='col'>
...
const steps = [
	...
	// },
	{
		selector: getTargetName('profile'),
		content: () => <ProfileTour />,
	},
	/**
	 * Lang Selector
