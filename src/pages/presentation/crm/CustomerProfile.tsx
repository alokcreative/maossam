		...
		<PageWrapper title={demoPagesMenu.crm.subMenu.customersList.text}>
			<SubHeader>
				<SubHeaderLeft>
					...
					<span className='text-muted'>Edit Customer</span>
				</SubHeaderLeft>
				{/* <SubHeaderRight>
					<Button
						color='dark'
			...
			<Page>
				<div className='row h-100 pb-3'>
								...
								<div className='row g-3'>
									...
									<div className='col-12'>
										<Button
											...
											color='info'
											className='w-100 p-3'
											isLight={TABS.ASSOCIATE_PRODUCTS !== activeTab}
											onClick={() => setActiveTab(TABS.ASSOCIATE_PRODUCTS)}>
											{TABS.ASSOCIATE_PRODUCTS}
										</Button>
									</div>
								</div>
							</CardBody>
					...
					<div className='col-lg-8 col-md-6'>
						...
						{TABS.ASSOCIATE_PRODUCTS === activeTab && (
							<Card stretch tag='form' noValidate>
								<CardHeader>
									<CardLabel icon='LocalPolice' iconColor='info'>
