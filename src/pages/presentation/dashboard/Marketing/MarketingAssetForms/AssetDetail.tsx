...
import { CardProp } from '../../../../../common/data/marketingAssetDummyData';
...
const AssetDetail = () => {
	...
	const data = MarketingAssetData.find((f: CardProp) => f.id === Number(id));
	...
	const userTasks = dummyEventsData;
		...
		<PageWrapper title={`${data && data.name}`}>
			...
			<Page>
				<div className='pt-3 pb-5 d-flex align-items-center'>
					<div className='h2 fw-bold ms-2'>{`${data && data.name}`}</div>
					<span className='ms-5 border border-success border-2 text-success fw-bold px-3 py-2 rounded'>
						{data && data.teamName}
					</span>
				</div>
				<div className='row'>
							...
							<CardBody>
								<div className='row g-5'>
									<div className='col-12 d-flex justify-content-center'>
										{data && <Avatar src={data.image} srcSet={data.image} />}
									</div>
											...
											<div className='col-12'>
												<div className='d-flex align-items-center'>
													<div className='flex-shrink-0'>
														<Icon icon='info' size='3x' color='info' />
													</div>
