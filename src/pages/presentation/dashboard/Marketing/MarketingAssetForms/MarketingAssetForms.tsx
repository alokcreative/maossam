				...
				<ModalBody className={isOpenModal ? 'opacity-25' : ''}>
					<div className='row p-auto'>
						<div className=' mb-4'>
							...
							<p>
								we're excited to review your marketing assets together. This step
								will allow us to check with you the existing and future marketing
								channels to develop your business and review the setup and features
								not to be missed.
							</p>
							<p className='mb-3'>
								Let’s get a quick tour in the social media world and check out
														...
														<div className='col-12'>
															...
															<div className='row my-3'>
																<div
																	...
																	<h5 className='card-title'>
																		Would a {nameOfBussiness}{' '}
																		Group help you promote your
																		business?
																	</h5>
																</div>
															</div>
