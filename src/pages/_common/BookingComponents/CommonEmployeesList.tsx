...
const CommonEmployeesList = () => {
	const dataEmployees = [
		{
			id: 1,
			name: `${USERS.GRACE.name} ${USERS.GRACE.lastname}`,
			ofAppointments: 3,
			sumOfPayments: 48,
		...
		{
			id: 2,
			name: `${USERS.JANE.name} ${USERS.JANE.lastname}`,
			ofAppointments: 3,
			sumOfPayments: 32,
		...
		{
			id: 3,
			name: `${USERS.RYAN.name} ${USERS.RYAN.lastname}`,
			ofAppointments: 3,
			sumOfPayments: 56,
		...
		{
			id: 4,
			name: `${USERS.ELLA.name} ${USERS.ELLA.lastname}`,
			ofAppointments: 3,
			sumOfPayments: 72,
			ofHoursInAppointment: 3,
			ofLoad: 56,
		...
		{
			id: 5,
			name: `${USERS.CHLOE.name} ${USERS.CHLOE.lastname}`,
			ofAppointments: 3,
			sumOfPayments: 60,
			ofHoursInAppointment: 3,
			ofLoad: 44,
