...
export const SELECT_OPTIONS_CONNECTION = [
	{ value: 1, text: 'Friend' },
	{ value: 2, text: 'Colleague' },
];
export const SELECT_OPTIONS_SOCIAL_SHARE = [
	{ value: 1, text: 'Send with Mail' },
	{ value: 2, text: 'Share with Whatsapp' },
];
const SelectPage = () => {
	const GENERAL_USAGE = `
<Select
